...
startbtn.addEventListener('click', function() {
    ...
    snake.style.animation = 'snake 4.2s linear infinite';
    centi.style.animation = 'centipiede 3.7s linear infinite'; 
    ...
    coin4.style.animation = 'coin4 4s linear infinite'; 
    ...
    setInterval(()=>{
        ...
        var manLeft = (Math.abs(man.getBoundingClientRect().left)+30);
